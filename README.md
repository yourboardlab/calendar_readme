...
안드로이드 **홈 화면**에 **2×2 위젯**을 추가할 수 있습니다. 위젯 목록에서 앱 이름(**Lifelong Calendar**, **요미 달력** 등, 기기·스토어에 따라 표시가 다를 수 있음)으로 항목을 찾아 바탕화면에 놓으면 됩니다.

- **내용**: 오늘 날짜 한 줄과, 앱에서 마지막으로 맞춰 둔 **기분 캐릭터** 이미지가 보입니다.
