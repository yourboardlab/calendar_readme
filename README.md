...
**Lifelong Calendar** 는 그 중간을 노렸습니다.
...
<p align="center">
  <img src="assets/release_hdr_score.png" alt="스코어 카드" width="300" />
</p>
...
즉, 1일에는 비어 있지만 한 달이 흐를수록 *이 달의 나는 어떤 사람이었는가* 가 자연스럽게 한 컷으로 떠오르도록 했습니다.
...
접었다 펼 수 있는 카드 형식으로, 기분은 상위 4개 이모티콘 GIF 크기로 한 달 요약을 보여 주고, 썼니/했니는 0을 기준으로 위·아래 막대 + 누적 꺾은선, 스코어는 항목별 꺾은선으로 표시됩니다. 각 차트 **좌측에는 최고/중간/0/최저 수치가 작게 표시**되어 한눈에 규모를 가늠할 수 있습니다.
...
<p align="center">
  <img src="assets/calendar_landscape.png" alt="가로 모드 달력 화면" width="520" />
</p>
