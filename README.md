...
> `https://github.com/yourboardlab/calendar_readme#비공개-테스트에게-바라는-점`  
...
- **비공개 테스터 안내:** [비공개 테스트에게 바라는 점](https://github.com/yourboardlab/calendar_readme#비공개-테스트에게-바라는-점)
...
**Q. 데이터가 다른 기기로 옮겨지나요?**
설정에서 **내보내기 → ZIP 파일** 로 백업한 뒤, 새 기기에서 **불러오기** 로 복원하시면 됩니다. 기록된 데이터는 **하나의 ZIP 파일**로 묶여 옮겨집니다.
